      ...
      <ul className='nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-bold px-9'>
        <li className='nav-item'>
          <a
            ...
            data-bs-toggle='tab'
            href='vrevolution-web-frontend/src/_metronic/partials/layout/header-menus/HeaderNotificationsMenu#kt_topbar_notifications_1'
          >
            Alerts
          </a>
        </li>
        ...
        <li className='nav-item'>
          <a
            ...
            data-bs-toggle='tab'
            href='vrevolution-web-frontend/src/_metronic/partials/layout/header-menus/HeaderNotificationsMenu#kt_topbar_notifications_2'
          >
            Updates
          </a>
        </li>
        ...
        <li className='nav-item'>
          <a
            className='nav-link text-white opacity-75 opacity-state-100 pb-4'
            data-bs-toggle='tab'
            href='vrevolution-web-frontend/src/_metronic/partials/layout/header-menus/HeaderNotificationsMenu#kt_topbar_notifications_3'
          >
            Logs
          </a>
        </li>
            ...
            <div key={`alert${index}`} className='d-flex flex-stack py-4'>
              <div className='d-flex align-items-center'>
                ...
                <div className='mb-0 me-2'>
                  <a href='vrevolution-web-frontend/src/_metronic/partials/layout/header-menus/HeaderNotificationsMenu#' className='fs-6 text-gray-800 text-hover-primary fw-bolder'>
                    {alert.title}
                  </a>
        ...
        <div className='d-flex flex-column px-9'>
          <div className='pt-10 pb-0'>
            ...
            <div className='text-center mt-5 mb-9'>
              <a
                href='vrevolution-web-frontend/src/_metronic/partials/layout/header-menus/HeaderNotificationsMenu#'
          ...
          {defaultLogs.map((log, index) => (
            <div key={`log${index}`} className='d-flex flex-stack py-4'>
              <div className='d-flex align-items-center me-2'>
                ...
                <a href='vrevolution-web-frontend/src/_metronic/partials/layout/header-menus/HeaderNotificationsMenu#' className='text-gray-800 text-hover-primary fw-bold'>
                  {log.message}
                </a>
