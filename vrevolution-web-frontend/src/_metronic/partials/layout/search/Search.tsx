          ...
          >
            ...
            <div ref={resultsElement} data-kt-search-element='results' className='d-none'>
              <div className='scroll-y mh-200px mh-lg-350px'>
                ...
                <a
                  href='/Users/Enes Yağız Yılmaz/ceng-407-408-2023-2024-Simulating-Scientific-Experiments-Using-Virtual-Reality/vrevolution-web-frontend/public#'
            ...
            <div ref={suggestionsElement} className='mb-4' data-kt-search-element='main'>
              ...
              <div className='scroll-y mh-200px mh-lg-325px'>
                <div className='d-flex align-items-center mb-5'>
                  ...
                  <div className='d-flex flex-column'>
                    <a href='/Users/Enes Yağız Yılmaz/ceng-407-408-2023-2024-Simulating-Scientific-Experiments-Using-Virtual-Reality/vrevolution-web-frontend/public#' className='fs-6 text-gray-800 text-hover-primary fw-bold'>
