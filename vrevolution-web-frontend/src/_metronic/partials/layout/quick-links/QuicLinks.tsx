...
const QuickLinks: FC = () => (
  ...
  >
    ...
    <div className='row g-0'>
      <div className='col-6'>
        <a
          href='vrevolution-web-frontend/src/_metronic/partials/layout/quick-links/QuicLinks#'
      ...
      <div className='col-6'>
        <a href='vrevolution-web-frontend/src/_metronic/partials/layout/quick-links/QuicLinks#' className='d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end'>
      ...
      <div className='col-6'>
        <a href='vrevolution-web-frontend/src/_metronic/partials/layout/quick-links/QuicLinks#' className='d-flex flex-column flex-center h-100 p-6 bg-hover-light'>
