        ...
        <form ref={formRef} id='kt_inbox_compose_form' onSubmit={() => console.log('submit')}>
          ...
          <div className='d-flex align-items-center justify-content-between py-5 ps-8 pe-5 border-top'>
            ...
            <div className='d-flex align-items-center me-3'>
              ...
              {/*begin::Other*/}
              <a
                href='vrevolution-web-frontend/src/_metronic/partials/layout/InboxCompose#'
              ...
              <a href='vrevolution-web-frontend/src/_metronic/partials/layout/InboxCompose#' className='btn btn-icon btn-active-light-primary'>
