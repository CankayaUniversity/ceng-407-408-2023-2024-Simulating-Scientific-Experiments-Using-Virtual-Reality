    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 pt-5'>
        ...
        <div className='card-toolbar'>
          <a href='vrevolution-web-frontend/src/_metronic/partials/widgets/tables/TablesWidget11#' className='btn btn-sm btn-light-primary'>
          ...
          <table className='table align-middle gs-0 gy-4'>
            ...
            <tbody>
              <tr>
                <td>
                  <div className='d-flex align-items-center'>
                    ...
                    <div className='d-flex justify-content-start flex-column'>
                      <a href='vrevolution-web-frontend/src/_metronic/partials/widgets/tables/TablesWidget11#' className='text-dark fw-bold text-hover-primary mb-1 fs-6'>
                ...
                <td>
                  <a href='vrevolution-web-frontend/src/_metronic/partials/widgets/tables/TablesWidget11#' className='text-dark fw-bold text-hover-primary d-block mb-1 fs-6'>
                    $2,790
                  </a>
                ...
                <td className='text-end'>
                  <a
                    href='vrevolution-web-frontend/src/_metronic/partials/widgets/tables/TablesWidget11#'
                  ...
                  <a href='vrevolution-web-frontend/src/_metronic/partials/widgets/tables/TablesWidget11#' className='btn btn-icon btn-bg-light btn-active-color-primary btn-sm'>
