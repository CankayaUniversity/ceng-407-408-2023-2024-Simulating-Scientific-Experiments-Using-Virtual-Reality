          ...
          <table className='table align-middle gs-0 gy-5'>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <a href='vrevolution-web-frontend/src/_metronic/partials/widgets/tables/TablesWidget1#' className='text-dark fw-bold text-hover-primary mb-1 fs-6'>
                    Top Authors
                  </a>
                ...
                <td className='text-end'>
                  <a href='vrevolution-web-frontend/src/_metronic/partials/widgets/tables/TablesWidget1#' className='btn btn-sm btn-icon btn-bg-light btn-active-color-primary'>
