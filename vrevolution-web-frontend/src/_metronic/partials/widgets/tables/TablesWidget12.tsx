      ...
      <div className='card-header border-0 pt-5'>
        ...
        <div className='card-toolbar'>
          ...
          >
            ...
            {/* begin::Menu item */}
            <div className='menu-item px-3'>
              <a href='vrevolution-web-frontend/src/_metronic/partials/widgets/tables/TablesWidget12#' className='menu-link px-3'>
                New Ticket
              </a>
            </div>
            {/* end::Menu item */}
            ...
            <div className='menu-item px-3'>
              <div className='menu-content px-3 py-3'>
                <a className='btn btn-primary btn-sm px-4' href='vrevolution-web-frontend/src/_metronic/partials/widgets/tables/TablesWidget12#'>
                  Generate Reports
                </a>
              </div>
            </div>
          ...
          <table className='table align-middle gs-0 gy-4'>
            ...
            <tbody>
              <tr>
                <td>
                  <div className='d-flex align-items-center'>
                    ...
                    <div className='d-flex justify-content-start flex-column'>
                      <a href='vrevolution-web-frontend/src/_metronic/partials/widgets/tables/TablesWidget12#' className='text-dark fw-bold text-hover-primary mb-1 fs-6'>
                        Brad Simmons
                      </a>
                ...
                <td>
                  <a href='vrevolution-web-frontend/src/_metronic/partials/widgets/tables/TablesWidget12#' className='text-dark fw-bold text-hover-primary d-block mb-1 fs-6'>
                    $8,000,000
                  </a>
                ...
                <td className='text-end'>
                  <a
                    href='vrevolution-web-frontend/src/_metronic/partials/widgets/tables/TablesWidget12#'
