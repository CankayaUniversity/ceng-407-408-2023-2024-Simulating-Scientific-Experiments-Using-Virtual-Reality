          ...
          <ul className='nav'>
            <li className='nav-item'>
              <a
                ...
                data-bs-toggle='tab'
                href='vrevolution-web-frontend/src/_metronic/partials/widgets/tables/TablesWidget6#kt_table_widget_6_tab_1'
              >
                Month
              </a>
            </li>
            <li className='nav-item'>
              <a
                ...
                data-bs-toggle='tab'
                href='vrevolution-web-frontend/src/_metronic/partials/widgets/tables/TablesWidget6#kt_table_widget_6_tab_2'
              >
                Week
              </a>
            </li>
            <li className='nav-item'>
              <a
                ...
                data-bs-toggle='tab'
                href='vrevolution-web-frontend/src/_metronic/partials/widgets/tables/TablesWidget6#kt_table_widget_6_tab_3'
              >
                Day
              </a>
            </li>
              ...
              <table className='table align-middle gs-0 gy-3'>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a href='vrevolution-web-frontend/src/_metronic/partials/widgets/tables/TablesWidget6#' className='text-dark fw-bold text-hover-primary mb-1 fs-6'>
                        Brad Simmons
                      </a>
                    ...
                    <td className='text-end'>
                      <a
                        href='vrevolution-web-frontend/src/_metronic/partials/widgets/tables/TablesWidget6#'
