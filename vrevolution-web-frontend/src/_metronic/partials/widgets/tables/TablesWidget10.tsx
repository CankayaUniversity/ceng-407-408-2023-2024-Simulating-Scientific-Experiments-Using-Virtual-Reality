  ...
  return (
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 pt-5'>
        ...
        >
          <a
            href='vrevolution-web-frontend/src/_metronic/partials/widgets/tables/TablesWidget10#'
          ...
          <table className='table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4'>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <div className='d-flex align-items-center'>
                    ...
                    <div className='d-flex justify-content-start flex-column'>
                      <a href='vrevolution-web-frontend/src/_metronic/partials/widgets/tables/TablesWidget10#' className='text-dark fw-bold text-hover-primary fs-6'>
                        Ana Simmons
                      </a>
                ...
                <td>
                  <a href='vrevolution-web-frontend/src/_metronic/partials/widgets/tables/TablesWidget10#' className='text-dark fw-bold text-hover-primary d-block fs-6'>
                    Intertico
                  </a>
                  <span className='text-muted fw-semibold text-muted d-block fs-7'>
                    Web, UI/UX Design
