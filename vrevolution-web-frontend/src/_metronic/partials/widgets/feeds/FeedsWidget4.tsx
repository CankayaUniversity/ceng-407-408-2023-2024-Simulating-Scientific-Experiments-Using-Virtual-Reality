    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-body pb-0'>
        ...
        <div className='d-flex align-items-center mb-5'>
          ...
          <div className='d-flex align-items-center flex-grow-1'>
            ...
            <div className='d-flex flex-column'>
              <a href='vrevolution-web-frontend/src/_metronic/partials/widgets/feeds/FeedsWidget4#' className='text-gray-800 text-hover-primary fs-6 fw-bold'>
                Carles Nilson
              </a>
        ...
        <div className='mb-7'>
          ...
          <div className='d-flex align-items-center mb-5'>
            <a
              href='vrevolution-web-frontend/src/_metronic/partials/widgets/feeds/FeedsWidget4#'
