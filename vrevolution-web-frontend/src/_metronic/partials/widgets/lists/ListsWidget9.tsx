        ...
        <div className='d-flex mb-7'>
          ...
          <div className='d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1'>
            ...
            <div className='d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3'>
              <a href='vrevolution-web-frontend/src/_metronic/partials/widgets/lists/ListsWidget9#' className='fs-5 text-gray-800 text-hover-primary fw-bolder'>
                Cup &amp; Green
              </a>
              <span className='text-gray-400 fw-bold fs-7 my-1'>Study highway types</span>
              <span className='text-gray-400 fw-bold fs-7'>
                By:
                <a href='vrevolution-web-frontend/src/_metronic/partials/widgets/lists/ListsWidget9#' className='text-primary fw-bold'>
                  CoreAd
                </a>
              </span>
            </div>
