  ...
  return (
    ...
    >
      ...
      <div className='card-body'>
        <a href='vrevolution-web-frontend/src/_metronic/partials/widgets/statistics/StatisticsWidget1#' className='card-title fw-bold text-muted text-hover-primary fs-4'>
          {title}
        </a>
