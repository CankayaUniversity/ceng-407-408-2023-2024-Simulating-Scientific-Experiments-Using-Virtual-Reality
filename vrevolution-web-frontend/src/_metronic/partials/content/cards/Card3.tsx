  ...
  return (
    <div className='card'>
      <div className='card-body d-flex flex-center flex-column p-9'>
        ...
        <a href='vrevolution-web-frontend/src/_metronic/partials/content/cards/Card3#' className='fs-4 text-gray-800 text-hover-primary fw-bolder mb-0'>
          {name}
        </a>
        ...
        <a href='vrevolution-web-frontend/src/_metronic/partials/content/cards/Card3#' className='btn btn-sm btn-light'>
