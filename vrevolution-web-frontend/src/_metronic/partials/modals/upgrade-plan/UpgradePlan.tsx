          ...
          <div className='modal-body pt-0 pb-15 px-5 px-xl-20'>
            <div className='mb-13 text-center'>
              ...
              <div className='text-muted fw-bold fs-5'>
                ...
                <a href='vrevolution-web-frontend/src/_metronic/partials/modals/upgrade-plan/UpgradePlan#' className='link-primary fw-bolder'>
                  Pricing Guidelines
                </a>
                .
              </div>
            ...
            <div className='d-flex flex-column'>
              <div className='nav-group nav-group-outline mx-auto' data-kt-buttons='true'>
                <a
                  href='vrevolution-web-frontend/src/_metronic/partials/modals/upgrade-plan/UpgradePlan#'
                  className={
