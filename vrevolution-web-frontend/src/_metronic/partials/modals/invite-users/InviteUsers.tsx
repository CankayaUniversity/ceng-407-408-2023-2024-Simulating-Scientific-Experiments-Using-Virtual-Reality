          ...
          <div className='modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15'>
            <div className='text-center mb-13'>
              ...
              <div className='text-muted fw-bold fs-5'>
                ...
                <a href='vrevolution-web-frontend/src/_metronic/partials/modals/invite-users/InviteUsers#' className='link-primary fw-bolder'>
                  {' '}
                  FAQ Page
                </a>
                .
                  ...
                  return (
                    ...
                    >
                      <div className='d-flex align-items-center'>
                        ...
                        <div className='ms-5'>
                          <a
                            href='vrevolution-web-frontend/src/_metronic/partials/modals/invite-users/InviteUsers#'
