          ...
          <div className='row mb-8'>
            ...
            <div className='col-lg-9'>
              ...
              <div className='form-text'>
                ...
                <a href='vrevolution-web-frontend/src/app/modules/profile/components/account/Account#' className='fw-bold'>
                  Learn more
                </a>
                .
              </div>
          ...
          <div className='row mb-13'>
            ...
            <div className='col-lg-9'>
              ...
              <div className='form-text py-2'>
                ...
                reset your password.
                <a href='vrevolution-web-frontend/src/app/modules/profile/components/account/Account#' className='fw-boldk'>
                  Learn more
                </a>
                .
              </div>
